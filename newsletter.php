                            ...
                            <div class="card-body p-0">
                                <div class="card-title p-3 mb-0 newsletter">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="jane.doe@email.com">
                                    </div>
                                    <div class="mb-4">
                                        <label for="exampleFormControlInput2" class="form-label"><b>First Name</b></label>
                                        <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Jane">
                                    </div>
                                    <div class="mb-4">
                                        <label for="exampleFormControlInput3" class="form-label"><b>Last Name </b></label>
                                        <input type="text" class="form-control" id="exampleFormControlInput3" placeholder="Doe">
                                    </div>
                                </div>
                                <div class="marketing-permissions p-4">
                                    <h6><b>Marketing Permissions</b></h6>
                                    <p>
                                        Please select all the ways you would like to hear from Blackfin Capital Partners:
                                    </p>
